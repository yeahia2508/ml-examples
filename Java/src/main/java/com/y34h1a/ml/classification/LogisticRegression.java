...
public class LogisticRegression {
    public static void main(String args[]) throws IOException, ParseException {
        String fileName = "/home/y34h1a/StudioProjects/Mechine Learning Examples/Data/Social_Network_Ads.csv";
        ...
        for (int i = 0; i < n; i++) {
            ...
            smile.classification.LogisticRegression lr = new smile.classification.LogisticRegression(trainx, trainy);
